      ...
      <section id="portfolio" className="py-24 px-6 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card title="StockYard" tag="Livestock Marketplace" icon={<Layers className="w-6 h-6" />} color="from-amber-500 to-orange-500" description="Cattle market intelligence and proxy bidding. Live pricing, auction tracking, marketplace for dealers." stack="React, Supabase, USDA AMS data, Stripe" link="https://stockyard-lovat.vercel.app" />
